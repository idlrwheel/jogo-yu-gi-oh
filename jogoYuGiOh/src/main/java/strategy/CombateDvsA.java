 ...
 * @author Giovanna
 */
public class CombateDvsA implements EstrategiaCombate {
    ...
    public int executarCombate(Jogador jogador1, Carta cartaJogador1, String estadoJogador1, Jogador jogador2, Carta cartaJogador2, String estadoJogador2) {
        System.out.println("Combate: Defesa vs Ataque");
        System.out.println(jogador1.getNome() + " jogou: " +  " (Defesa: " + cartaJogador1.getDefesa() + ")");
        System.out.println(jogador2.getNome() + " jogou: " + " (Ataque: " + cartaJogador2.getDefesa() + ")");

        if (cartaJogador1.getDefesa() > cartaJogador2.getAtaque()) {
            System.out.println(jogador1.getNome() + " vence a rodada!");
            return 1;
        } else if (cartaJogador2.getAtaque() > cartaJogador1.getDefesa()) {
